...
let poseTopic = ntcore.createTopic<number[]>('/SmartDashboard/WheelTracker/Robot', NetworkTablesTypeInfos.kDoubleArray);
let limelights = [
...
let field = ntcore.createTopic<number[]>('/SmartDashboard/Robot State', NetworkTablesTypeInfos.kDoubleArray);
